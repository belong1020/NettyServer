...
import com.worldline.isa.model.IsoContainer;
import com.worldline.isa.model.IsoField;
import com.worldline.isa.model.IsoHeaderList;
...
//				this.isoConfig.put(String.valueOf(pack.getMti()), pack);
				//预留 map-key 后期可再添加更名mti 做不同银行key 值
				this.isoConfig.put("iso8583", pack);
			}
		} finally {
			if (is != null) {
				is.close();
