...
public class TestClientHandler0004 extends SimpleChannelInboundHandler<ByteBuf> {
	...
	public void channelActive(ChannelHandlerContext ctx) {
		...
		message.put("7", "0227141202");
		message.put("11", "107488");
		...
		message.put("128", "4430393641364642");
